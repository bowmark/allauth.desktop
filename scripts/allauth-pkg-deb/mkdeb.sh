...
Depends: mono-runtime (>= 3.2~), libmono-system-windows-forms4.0-cil, libmono-system-data-linq4.0-cil, libmono-system-xml-linq4.0-cil, libmono-system-management4.0-cil, libsqlcipher0, libgnome-keyring1.0-cil
